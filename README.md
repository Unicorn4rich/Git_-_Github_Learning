...
# Git & GitHub Documentation - Shoaib

This document explains some basic and intermediate Git & GitHub commands with their simple Roman Urdu explanations.

---

### 1. `git init`
**Explanation**: Git initialize karne ke liye use hota hai. Yeh command current folder ko git repository bana deta hai.

### 2. `git add .`
**Explanation**: Saari files ko track karne ke liye. Yeh command har file ko staging area mein daal deti hai.

### 3. `git commit -m "New change"`
**Explanation**: Commit ka matlab hota hai ek snapshot lena project ka. Step by step har change ko save karne ke liye.

### 4. `git remote add origin https://github.com/Unicorn4rich/Git_-_Github_Learning.git`
**Explanation**: Apne local git repo ko GitHub ke repo se connect karna.

### 5. `git push -u origin main`
**Explanation**: Code ko GitHub pe bhejna. Yeh by default main branch pe code push karta hai.

---

### 6. `git checkout 14d832228a677a0a4923d127c4912a850d8434a5`
**Explanation**: Kisi purani commit pe wapas jaana. Jab hum kisi purani commit pe jate hain to Git humein ek temporary branch (detached HEAD) mein le jata hai jahan hum changes kar sakte hain. Lekin agar hum is branch ko GitHub pe push karna chahenge to error aayega kyunki iska GitHub ke original main branch se koi taluq nahi hota.

### 7. `git switch main`
**Explanation**: Main branch pe wapas jaane ke liye. Temporary branch khud ba khud delete ho jaati hai aur main branch ka latest clean code aa jata hai.

### 8. `git switch -c newBranch`
**Explanation**: Detached HEAD wali branch ke changes ko ek nayi branch mein save karne ke liye.

### 9. New Branch ko GitHub pe push karne ke steps:
```
git add .
git commit -m "helloooo"
git push --set-upstream origin newBranch
```
**Note**: Ab GitHub pe repo refresh karo, nayi branch dikhayi degi.

---

### 10. `git branch`
**Explanation**: Current branch dekhne ke liye. Agar branch ka naam change karna ho:
```
git branch -M helloBranch
```

### 11. `git merge helloBranch`
**Explanation**: Main branch mein helloBranch ka data merge karne ke liye. Merge conflict aaye to manually solve karo using "Resolve in Merge Editor".

### 12. `git branch -d helloBranch`
**Explanation**: Merge karne ke baad unnecessary branch ko delete karne ke liye.
